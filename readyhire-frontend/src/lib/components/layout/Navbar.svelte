	...
	<Container>
		<div class="flex h-16 items-center justify-between">
			...
			<div class="hidden md:flex items-center gap-8">
				...
				<a href="#faqs" class="text-sm font-medium text-muted-foreground transition-colors hover:text-foreground">FAQs</a>
			</div>
		...
		<div class="border-b border-border/40 bg-background md:hidden">
			<div class="space-y-1 px-4 pb-4 pt-2">
				<a
					...
					class="block rounded-lg px-3 py-2 text-base font-medium text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
				>
					Features
				</a>
				<a
